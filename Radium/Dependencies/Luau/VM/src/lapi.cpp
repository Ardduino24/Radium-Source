...
const char* lua_ident = oxorany("$Lua: Lua 5.1.4 Copyright (C) 1994-2008 Lua.org, PUC-Rio $\n"
                        "$Authors: R. Ierusalimschy, L. H. de Figueiredo & W. Celes $\n"
                        "$URL: www.lua.org $\n");

const char* luau_ident = oxorany("$Luau: Copyright (C) 2019-2023 Roblox Corporation $\n"
                         "$URL: luau-lang.org $\n");
...
{
    return (t == LUA_TNONE) ? oxorany("no value") : luaT_typenames[t];
}
