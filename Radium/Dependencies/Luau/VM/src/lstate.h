...
typedef struct global_State
{
    ...
    GlobalstateTtnameEnc<TString*> ttname[LUA_T_COUNT],       // names for basic types
    GlobalstateTmnameEnc<TString*> tmname[TM_N]);             // array with tag-method names
...
struct lua_State
{
    ...
    VM_SHUFFLE6(Semicolon,
    StkId top,                                        // first free slot in the stack
    StkId base,                                       // base of current function
    LuastateGlobalEnc<global_State*> global,
    ...
    LuastateStacksizeEnc<int> stacksize;
...
constexpr int Lol44 = offsetof(lua_State, ci);
